...
class ApresentaModeradoresPage extends React.Component {
    ...
    return(
        ...
        <div className="fundo">
            <a href='/usuarios/criar' className='btn btn-primary btn-lg'>Novo Moderador</a>
...
export default ApresentaModeradoresPage ;